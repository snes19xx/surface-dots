...
FocusScope {
    ...
    readonly property color cSubtle: theme.subtleFill
    readonly property color cHoverFill: theme.subtleFillHover
    readonly property color cActive: theme.accent 
    readonly property color cDanger: theme.accentRed

    // Selection color profiles 
    readonly property real selTint:  isDark ? 0.74 : 0.34   
    readonly property real hovTint:  isDark ? 0.14 : 0.22   
    readonly property real iconTint: isDark ? 0.60 : 0.72
